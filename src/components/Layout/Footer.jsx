...
function Footer() {
  ...
  const popularDestinations = [
    { to: '/destinations/1', label: 'United Kingdom' },
    { to: '/destinations/2', label: 'United States' },
    { to: '/destinations/3', label: 'Canada' },
    { to: '/destinations/4', label: 'Australia' },
    { to: '/destinations/5', label: 'Malaysia' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Your trusted partner for international education opportunities. We guide students to achieve their dreams of studying abroad.
            </p>
            {/* Social Links */}
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm text-center md:text-left">
              &copy; {currentYear} StudyAbroad. All rights reserved.
            </p>
